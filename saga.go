...
// func NewOperation(try TxFunc, secondaryOp *Operation) *Operation {
// 	return &Operation{tryFunc: try, secondaryOp: secondaryOp}
// }
//
// type FailChain interface {
// 	AppendOp(op *Operation)
// 	ExecuteOp(op *Operation) error
// 	ExecuteAllOps() error
// }
//
// type Chain struct {
...
// 	tryFunc     func() error
// 	secondaryOp *Operation
// }
//
// func (t *Chain) AppendOp(operation *Operation) {
// 	t.ops = append(t.ops, operation)
// }
//
// func (t *Chain) ExecuteOp(operation *Operation) error {
// 	t.lock.Lock()
// 	defer t.lock.Unlock()
//
// 	t.completedErr = nil
...
//
// 	if err != nil {
// 		t.AppendOp(operation.secondaryOp)
// 	}
//
// 	t.handleCompletion(err)
// 	if t.completedErr != nil {
...
// }
//
// func (t *Chain) ExecuteAllOps() error {
// 	t.lock.Lock()
// 	defer t.lock.Unlock()
//
// 	t.completedCount = 0
...
// 			var err error
// 			if t.retries {
// 				err = Retry(op.tryFunc, t.RetryOptions)
// 			} else {
// 				err = op.tryFunc()
// 			}
// 			t.handleCompletion(err)
